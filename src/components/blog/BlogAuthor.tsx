export function BlogAuthor({ author }: { author: string }) {
  return (
    <section className="mt-12 rounded-2xl border border-[#e8e4de] p-6">
      ...
      <p className="mt-3 text-[#4a4a4a]">{author} is a Melbourne-based automation engineering team delivering PLC, SCADA, and controls integration projects across Australia.</p>
    </section>
  )
}
