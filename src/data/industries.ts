...
export const industries: IndustryContent[] = [
  ...
  {
    slug: 'agricultural-processing', name: 'Agricultural Processing', targetKeyword: 'agricultural processing automation Australia', title: 'Agricultural Processing Automation | Metromotion Controls',
    metaDescription: 'Agricultural processing automation for seed, orchard, packhouse and fruit processing facilities across Australia.',
    heroSummary: ['Agricultural processing sites need dependable controls across variable seasonal loads, changing raw material quality and tight dispatch windows. Metromotion Controls engineers practical automation for seed processing, orchard and packhouse operations, and fruit processing lines.', 'Our delivery approach prioritises reliable throughput, traceability and maintainability. We design control systems that support both day-to-day operations and phased upgrades around live production.', 'Projects are scoped and delivered by engineers who understand real plant constraints including shutdown limits, legacy equipment and compliance reporting requirements.'],
    challenges: [{ title: 'Seasonal throughput variability', detail: 'Processing rates and product mix can shift significantly by season, requiring flexible control strategies and clear operator workflows.' }, { title: 'Mixed legacy and modern equipment', detail: 'Many sites run older machines beside new skids and conveyors, which creates interface and reliability issues.' }, { title: 'Traceability across receival to dispatch', detail: 'Sites need clean lot tracking and production records without adding manual admin burden.' }, { title: 'Harsh operating environments', detail: 'Dust, vibration, temperature variation and washdown zones can impact instrumentation and control hardware reliability.' }],
    solutions: ['We implement robust sequence control for intake, cleaning, grading, transfer, storage and packing operations with clear permissives and fault recovery.', 'Integration includes weigh systems, conveyors, sorters, packaging machines and site reporting platforms so operations get one coherent view of performance.', 'Traceability is built into PLC and SCADA design with event capture, lot context and structured production records for QA and customer reporting.', 'Architectures are designed for staged upgrades, allowing facilities to modernise critical assets without unnecessary disruption to production.'],
    typicalProjects: [{ name: 'Seed receival and cleaning control upgrade', scope: 'Modern PLC and HMI implementation with route validation, weigh integration and production event capture.' }, { name: 'Packhouse line coordination project', scope: 'Integration of graders, conveyors, case handling and palletising with central line-state control and downtime visibility.' }, { name: 'Fruit processing utilities and CIP integration', scope: 'Coordinated control of process utilities, cleaning cycles and production changeovers with operator guidance and reporting.' }, { name: 'Traceability and reporting deployment', scope: 'Lot-to-dispatch data model linking process events, quality checks and packaging identifiers.' }],
    platformsIntro: 'Agricultural processing environments need controls that are robust, supportable and straightforward for site teams to maintain.',
    platforms: ['Rockwell, Siemens and Ignition-based architectures matched to plant scale and support requirements.', 'Field integration across conveyors, weigh systems, vision systems, drives and instrumentation.', 'Protocols including EtherNet/IP, Profinet, Modbus TCP and OPC UA.', 'Historian and SQL reporting layers for production and quality data.'],
    standards: ['Site quality and traceability requirements for agricultural products.', 'AS/NZS machinery safety and electrical compliance obligations.', 'Structured FAT/SAT and commissioning documentation.', 'Practical cybersecurity controls for connected OT environments.'],
    faqs: [{ question: 'Can upgrades be delivered outside peak season?', answer: 'Yes. We commonly plan staged delivery around harvest and dispatch cycles to reduce operational risk.' }, { question: 'Do you support packhouse and processing integration in one scope?', answer: 'Yes. We can deliver line-level and plant-level integration so upstream and downstream operations are coordinated.' }, { question: 'How quickly can traceability reporting improve?', answer: 'Once core event capture is in place, most sites see immediate improvement in report quality and response speed.' }],
  },
  {
    slug: 'building-products', name: 'Building Products', targetKeyword: 'building products automation Melbourne', title: 'Building Products Automation | Metromotion Controls',
    metaDescription: 'Building products automation for bricks, tiles, pavers and heavy clay manufacturing with precise process control and reliable uptime.',
    heroSummary: ['Building products manufacturing requires dependable control across heavy clay handling, forming, drying, firing and packaging. Metromotion Controls delivers automation engineering for bricks, tiles, pavers and related process lines.', 'We focus on robust sequence control, clear diagnostics and practical commissioning so sites can maintain throughput and quality under continuous production pressure.', 'Our team works across legacy and modern platforms, supporting both targeted upgrades and broader controls modernisation programs.'],
    challenges: [{ title: 'Continuous process stability', detail: 'Dryers, kilns and transfer systems need tightly coordinated control to maintain product quality and avoid production disruptions.' }, { title: 'Legacy controls and limited diagnostics', detail: 'Older systems often make fault isolation slow and increase maintenance burden during outages.' }, { title: 'Energy-intensive operations', detail: 'Building products sites need better visibility of process performance and utility consumption to support optimisation.' }, { title: 'Safety and reliability in harsh conditions', detail: 'Heat, dust and high-duty equipment place high demands on controls, electrical systems and instrumentation.' }],
    solutions: ['We implement modern PLC and SCADA architectures with state-based control, alarm clarity and reusable engineering standards for maintainability.', 'Process control strategies are designed around real operating constraints including kiln schedules, material handling sequences and dispatch requirements.', 'We integrate production and utility data to improve operational visibility and support energy and downtime reduction programs.', 'Commissioning is staged with clear test plans and fallback paths so upgrades can be delivered with controlled production risk.'],
    typicalProjects: [{ name: 'Kiln and dryer control modernisation', scope: 'Upgrade of legacy control hardware and operator interfaces with improved process visibility and alarm management.' }, { name: 'Heavy clay material handling integration', scope: 'End-to-end sequence control across feeders, conveyors, mixers and transfer points with fault-tolerant recovery logic.' }, { name: 'Tiles and pavers line optimisation', scope: 'Line-state and changeover improvements across forming, curing and packaging operations.' }, { name: 'Production and utility analytics rollout', scope: 'Data model and dashboards for throughput, downtime and utility performance across core assets.' }],
    platformsIntro: 'Building products plants require control platforms that can handle continuous operations and demanding environments.',
    platforms: ['Rockwell and Siemens PLC/SCADA deployments for high-availability production environments.', 'Integration of drives, burners, instrumentation, weigh systems and packaging assets.', 'Industrial networking and OT architecture designed for reliability and secure support access.', 'Historian and reporting systems aligned to operations and maintenance workflows.'],
    standards: ['AS/NZS electrical and machinery safety requirements.', 'Documented commissioning aligned to plant acceptance criteria.', 'Structured alarm and control standards for maintainability.', 'Practical OT cybersecurity controls for industrial operations.'],
    faqs: [{ question: 'Do you replace all controls at once?', answer: 'Not necessarily. Most building products projects are staged to balance risk, budget and production continuity.' }, { question: 'Can you work with existing kilns and process equipment?', answer: 'Yes. We regularly integrate with existing equipment and improve control without full plant replacement.' }, { question: 'Do you provide long-term support after commissioning?', answer: 'Yes. We support ongoing optimisation, fault response and lifecycle upgrades after handover.' }],
  },
]
